<?php 
	...
	class UsuariosModel extends Mysql
	{
		...
		public function insertUsuario($identificacion,$nombre,$apellido,$telefono,$email,$password,$tipoid,$status){
		...
		public function updateUsuario($idUsuario,$identificacion,$nombre,$apellido,$telefono,$email,$password,$tipoid,$status){
		...
		public function updatePerfil($idUsuario,$identificacion,$nombre,$apellido,$telefono,$password){
			$this->intIdUsuario = $idUsuario;
			$this->strIdentificacion = $identificacion;
			$this->strNombre = $nombre;
			$this->strApellido = $apellido;
		...
		public function updateDataFiscal($idUsuario,$strNit,$strNomFiscal,$strDirFiscal){
			$this->intIdUsuario = $idUsuario;
			$this->strNit = $strNit;
