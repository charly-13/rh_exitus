...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableDepartamentos = $('#tableDepartamentos').dataTable( {
        ...
        "columns":[
            {"data":"iddepartamento",className: "text-sm"},
            {"data":"nombre",className: "text-sm"},
    ...
    formDepartamento.onsubmit = function(e) {
        ...
        let ajaxUrl = base_url+'/Departamentos/setDepartamento'; 
        let formData = new FormData(formDepartamento);
        ...
        request.onreadystatechange = function(){
           if(request.readyState == 4 && request.status == 200){
                ...
                if(objData.status)
                {
                    ...
                    $('#modalFormDepartamentos').modal("hide");
                    formDepartamento.reset();
                    Swal.fire("Departamento", objData.msg ,"success");                  
                }else{
...
function fntDelInfo(idcategoria){
    Swal.fire({
        ...
        {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url+'/Departamentos/delDepartamento';
