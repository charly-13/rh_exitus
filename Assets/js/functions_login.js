...
function myFunction() {
    var btnlogin_reset = document.getElementById("login_reset");
	var divlogin_acceso = document.getElementById("login_acceso");

    if (btnlogin_reset.style.display === "none") {
		divlogin_acceso.style.display="none";
        btnlogin_reset.style.display = "block";
    } else {
        btnlogin_reset.style.display = "none";
    }
}
