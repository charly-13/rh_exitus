...
window.addEventListener('load', function() {
    if(document.querySelector("#formVacantes")){
        let formVacantes = document.querySelector("#formVacantes");
        formVacantes.onsubmit = function(e) {
            e.preventDefault();
            ...
            let formData = new FormData(formVacantes);
...
{
    rowTable = "";
    document.querySelector('#idVacante').value ="";
    document.querySelector('.modal-header').classList.replace("headerUpdate", "headerRegister");
    document.querySelector('#btnActionForm').classList.replace("btn-info", "btn-primary");
    document.querySelector('#btnText').innerHTML ="Guardar";
    document.querySelector('#titleModal').innerHTML = "Nueva Vacante";
    document.querySelector("#formVacantes").reset();
