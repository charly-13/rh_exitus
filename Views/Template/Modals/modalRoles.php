            ...
            <div class="tile-body">
              <form id="formRol" name="formRol">
                ...
                <div class="tile-footer">
                  <button id="btnActionForm" class="btn bg-gradient-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i><span id="btnText">Guardar</span></button>&nbsp;&nbsp;&nbsp;<a class="btn bg-gradient-secondary" href="#" data-bs-dismiss="modal" ><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                </div>
              </form>
            </div>
          </div>
