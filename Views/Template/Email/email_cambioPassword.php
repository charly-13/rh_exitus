		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Recientemente solicitó restablecer la contraseña de su cuenta, accede al enlace de abajo para confirmar tu contraseña. </p>
					<p class="x_text_white">
					<a href="<?= $data['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Confirmar datos</a>
					</p>
					<p style="font-size: 12px;">Si no solicitó un restablecimiento de contraseña, ignore este correo electrónico o responda para informarnos. Este enlace de restablecimiento de contraseña solo es válido durante los próximos 30 minutos.</p>
					<br>
