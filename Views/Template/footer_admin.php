...
<script src="<?= media(); ?>/js/jquery-3.3.1.min.js"></script>
  ...
  <script src="<?= media(); ?>/js/plugins/threejs.js"></script>
  <script src="<?= media(); ?>/js/plugins/orbit-controls.js"></script>
  ...
  <script type="text/javascript" src="<?= media(); ?>/js/plugins/jquery.dataTables.min.js"></script>
    ...
    <script type="text/javascript" src="<?= media(); ?>/js/plugins/bootstrap.min.js"></script>
