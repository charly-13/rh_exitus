...
<div id="divLoading" >
        ...
        <nav class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="../../../pages/dashboards/default.html">
              BIENVENIDO A EXITUS CAPITAL HUMANO
            </a>
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
              <ul class="navbar-nav navbar-nav-hover mx-auto">
                <li class="nav-item dropdown dropdown-hover mx-2">
                  <!-- <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                    Pages
                    <img src=" <?= media(); ?>/img/down-arrow-dark.svg  " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
                    <img src="<?= media(); ?>/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
                  </a> -->
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                  ...
                  <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3" aria-labelledby="dropdownMenuAccount">
                    <div class="row d-none d-lg-flex">
                      <div class="col-6">
                        <div class="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image" style="background-image:url('<?= media(); ?>/img/curved-images/curved8.jpg')">
                        ...
                        <ul class="list-group">
                          <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                            <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1" id="dropdownSignIn">
                              <span>Sign In</span>
                              <img src="<?= media(); ?>/img/down-arrow.svg" alt="down-arrow" class="arrow">
                            </a>
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1" onclick="smoothToPricing('pricing-soft-ui')">Inicio</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <main class="main-content main-content-bg mt-0" id="login_acceso">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-start">
                  <h3 class="font-weight-bolder text-danger text-gradient"><?= $data['page_title']; ?></h3>
                  <p class="mb-0">¡Bienvenido!</p>
                </div>
                <div class="card-body">
                  <form class="text-start" name="formLogin" id="formLogin" action="">
                    <label>USUARIO</label>
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-danger w-100 mt-4 mb-0 text-white">ACCESO</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  ...
                  ¿Olvidaste tu contraseña?
                    <a id="mostrar_form_reset" href="javascript:;" class="text-danger text-gradient font-weight-bold" onclick="myFunction()">>Recuperar</a>
                  </p>
                </div>
              </div>
            </div>
  ...
  <main class="main-content main-content-bg mt-0" id="login_reset" style="display: none">
    <section class="login-box">
      <div class="page-header min-vh-75">
        <div class="container">
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder text-danger text-gradient mb-5">¿Olvidaste contraseña?</h4>
                  <p class="mb-0">Las instrucciones de recuperación de contraseña se envían al correo electrónico especificado en el registro.</p>
                </div>
                <div class="card-body">
                  <form class="text-start" id="formRecetPass" name="formRecetPass"  action="">
                    <label>Email</label>
                    <div class="mb-3">
                      <input id="txtEmailReset" name="txtEmailReset" type="email" class="form-control" placeholder="Correo electrónico" aria-label="Email">
                    </div>
                    
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-danger w-100 mt-4 mb-0 text-white">RECUPERAR</button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                  Iniciar Sesión
                    <a href="./" class="text-danger text-gradient font-weight-bold">Iniciar</a>
                  </p>
                </div>
              </div>
            </div>
